...
public class IOBuffer2 implements IBuffer {
	 ...
	 * 把字节数组存入缓存块,自动扩容
	 * 
	 * @see connector.buffer.IOBuffer2#put(byte[])
	 * @param src
	 */
	@Override
	 ...
	 * 
	 * @see connector.buffer.IOBuffer2#put(byte[], int, int)
	 * @param src
	 * @param offset
	 * @param length
	 */
...
//	}
	 ...
	 * 从通道中读取
	 * 
	 * @see connector.buffer.IOBuffer2#readFromChannel()
	 * @return 是否成功读入
	 */
	@Override
	...
	/**
	 *
	 * @see connector.buffer.IOBuffer2#ready4WriteToChannel()
	 */
	@Override
	 ...
	 * 把数据写入通道
	 * 
	 * @see connector.buffer.IOBuffer2#writeToChannel()
	 * @return 是否全部写入
	 */
	@Override
	 ...
	 * 为即将写入的数据大小做好准备
	 * 
	 * @see connector.buffer.IBuffer#prepare(int)
	 * 
	 * @param size
	 */
	@Override
