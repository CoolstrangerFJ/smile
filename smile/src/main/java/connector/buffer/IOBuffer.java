...
public class IOBuffer implements IBuffer {
	 ...
	 * 把字节数组存入缓存块,自动扩容
	 * 
	 * @see connector.buffer.IOBuffer#put(byte[])
	 * @param src
	 */
	@Override
	 ...
	 * 
	 * @see connector.buffer.IOBuffer#put(byte[], int, int)
	 * @param src
	 * @param offset
	 * @param length
	 */
	 ...
	 * 从通道中读取
	 * 
	 * @see connector.buffer.IOBuffer#readFromChannel()
	 * @return 是否成功读入
	 */
	@Override
	...
	/**
	 *
	 * @see connector.buffer.IOBuffer#ready4WriteToChannel()
	 */
	@Override
	 ...
	 * 把数据写入通道
	 * 
	 * @see connector.buffer.IOBuffer#writeToChannel()
	 * @return 是否全部写入
	 */
	@Override
