...
import connector.buffer.BufferFactory;
import connector.buffer.IBuffer;
...
public class Response implements HttpServletResponse, ResponseWriter {
	 ...
	 * 
	 *
	 * @see connector.response.ResponseWriter#ready4Write()
	 */
	 ...
	 * 此方法主要用于测试
	 * 
	 * @see connector.response.ResponseWriter#write(java.lang.String)
	 * 
	 * @param s
	 */
	@Override
	 ...
	 * 尝试把缓存写入通道
	 * 
	 * @see connector.response.ResponseWriter#writeToChannel()
	 * 
	 * @return
	 */
	@Override
